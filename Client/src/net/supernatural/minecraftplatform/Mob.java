...
public boolean isCollidingWithBlock(Point pt1, Point pt2) {
	...
	public void render(Graphics g) {
		if(Component.dir == movementSpeed) {
			g.drawImage(Tile.tileset_terrain, (int) x - (int) Component.sX, (int) y - (int) Component.sY, (int) (x + width) - (int) Component.sX, (int) (y + height) - (int) Component.sY, /**/ (id[0] * Tile.tileSize) + (Tile.tileSize * animation), id[1] * Tile.tileSize, id[0] * Tile.tileSize + (Tile.tileSize * animation) + (int) width, id[1] * Tile.tileSize + (int) height, null);   //first part, actual character image drawn out
		} else {
			g.drawImage(Tile.tileset_terrain, (int) x - (int) Component.sX, (int) y - (int) Component.sY, (int) (x + width) - (int) Component.sX, (int) (y + height) - (int) Component.sY, /**/ (id[0] * Tile.tileSize + (Tile.tileSize * animation) + (int) width), (id[1] * Tile.tileSize), (id[0] * Tile.tileSize) + (Tile.tileSize * animation), id[1] * Tile.tileSize + (int) height, null);   //first part, actual character image drawn out
		}
	}
}